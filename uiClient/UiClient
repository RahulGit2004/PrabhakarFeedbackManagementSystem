...
public class UiClient {
    public static void main(String[] args) {
        ...
        controller.assignBatch("7348891347","9113170895","c1");
...
// ********************************Ignore below this**************************************************************** //
    ...
    private static void populateStudent(Controller controller){
        ...
        //for batch-3
        controller.signup("Rahul","9798825716","1234","student");
        controller.signup("Prince","9798825716","1234","student");
        controller.signup("Ritik","9798825716","1234","student");
        controller.signup("Aman","9798825716","1234","student");
    }
}
